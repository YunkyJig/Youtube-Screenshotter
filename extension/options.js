...
chrome.storage.sync.get(['screenshotKey', 'playbackSpeedButtons', 'screenshotFunctionality', 'screenshotFileFormat', 'filenameRandomizer'], function(result) {
    ...
    FilenameRandomizerCheck.checked = result.filenameRandomizer;
});
...
FilenameRandomizerCheck.oninput = function() {
    chrome.storage.sync.set({'filenameRandomizer': this.checked})
}